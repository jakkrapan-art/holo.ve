...
func find_targets_in_rotated_range(context: SkillContext):
	...
	await Hitbox.create(actual_width, actual_height, callback, hitbox_position, parent_node, user_rotation, local_offset, Color(1, 0, 0, 0.25), 0.0, Hitbox.VisualKind.DEBUG_ONLY)
